...
namespace MediaBrowser.Controller.Dto
{
    ...
    public interface IDtoService
    {
        ...
        /// <returns>BaseItemDto.</returns>
        Task<BaseItemDto> GetBaseItemDtoAsync(BaseItem item, DtoOptions options, User? user = null, BaseItem? owner = null, CancellationToken token = default);
        ...
        /// <param name="token">The <see cref="CancellationToken"/>.</param>
        /// <returns>The <see cref="IReadOnlyList{T}"/> of <see cref="BaseItemDto"/>.</returns>
        Task<IReadOnlyList<BaseItemDto>> GetBaseItemDtosAsync(IReadOnlyList<BaseItem> items, DtoOptions options, User? user = null, BaseItem? owner = null, CancellationToken token = default);
        ...
        /// <param name="token">The <see cref="CancellationToken"/>.</param>
        /// <returns>The item dto.</returns>
        Task<BaseItemDto> GetItemByNameDtoAsync(BaseItem item, DtoOptions options, List<BaseItem>? taggedItems, User? user = null, CancellationToken token = default);
    }
}
