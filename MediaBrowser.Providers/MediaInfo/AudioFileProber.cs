...
namespace MediaBrowser.Providers.MediaInfo
{
    ...
    public class AudioFileProber
    {
        ...
        private async Task FetchDataFromTags(Audio audio, Model.MediaInfo.MediaInfo mediaInfo, MetadataRefreshOptions options, bool tryExtractEmbeddedLyrics, CancellationToken token = default)
        {
            ...
            if (audio.SupportsPeople && !audio.LockedFields.Contains(MetadataField.Cast))
            {
                ...
                await _libraryManager.UpdatePeopleAsync(audio, people, token).ConfigureAwait(false);
